...
class Solution:
    def __init__(self, cube: Cube):
        self.cube_copy = deepcopy(cube)

    def generate_solution(self):
        self.solve_cross(self.cube_copy)
        self.solve_corners(self.cube_copy)
        self.solve_middle_edges(self.cube_copy)
        self.solve_eoll(self.cube_copy)
        self.solve_ocll(self.cube_copy)
        self.solve_cpll(self.cube_copy)
        self.solve_epll(self.cube_copy)

        return self.cube_copy.move_history

    def solve_cross(self, cube: Cube):
        EDGES = {
            "UF": "",
            "UL": "U'",
            "UR": "U",
    ...
    def solve_corners(self, cube: Cube):
        CORNERS = {
            "UFR": "U2 U2",
            "DFR": "R U R' U'",
            "DBR": "R' U R U",
    ...
    def solve_middle_edges(self, cube: Cube):
        EDGES = {
            "UF": "U2 U2",
            "UR": "U",
            "UL": "U'",
